Shader "Hidden/IE_BlockSplit"
{
    Properties
    {
        ...
        _BlackStrength("Black Strength", Range(0,1)) = 0
    }
        SubShader
        {
            Cull Off
            ...
            Pass
            {
                ...
                fixed4 frag(v2f i) : SV_Target
                {
                    ...
                    return lerp(fixed4(0,0,0,1), lerp(colorR, fixed4(colorR.r , colorG.g, colorB.z, (colorR.a + colorG.a + colorB.a)), _Strength),1- _BlackStrength);
                }
                ENDCG
            }
        }
